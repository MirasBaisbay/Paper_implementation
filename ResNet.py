...
class ResNet(nn.Module):
    def __init__(self, block, layers, image_channels, num_classes):
        ...
        # Create a temporary block instance to access expansion
        temp_block = block(self.in_channels, 64)
        self.fc = nn.Linear(512 * temp_block.expansion, num_classes)
    ...
    def _make_layer(self, block, num_residual_blocks, intermediate_channels, stride):
        ...
        for i in range(1, num_residual_blocks):
            layers.append(self.block(self.in_channels, intermediate_channels))
